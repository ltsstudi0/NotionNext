...
const BLOG = {
  AUTHOR: 'LTS', // 作者
  BIO: 'Just Rolling', // 作者简介
  LINK: 'https://net.cano.one', // 网站地址
  ...
  CONTACT_EMAIL: 'lts@canostudio.xyz',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/ltsstudi0',
  CONTACT_TELEGRAM: 'https://t.me/ltsstudi0',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'LTS ' s  BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
